...
class CoreLocationSession: NSObject {
    ...
    override init() {
        ...
        //is the more agressive solution of GPS data collection
//        locationManager.startUpdatingLocation()
    ...
    private func startSigLocationChanges(){
        ...
        //less aggressive than the startUpdatingLocation() in GPS monitor changer
    ...
    public func convertPlacemarkToCoordinate(addressString: String) {
        CLGeocoder().geocodeAddressString(addressString) { (placemarks, error) in
            ...
            if let firstPlacemark = placemarks?.first,
                ...
                print("placename coordinate: \(location.coordinate)")
            }
        }
    }
    
    //monitor a CLRegion
    //a CLRegion is made up of center coordinate and a radius in meters
